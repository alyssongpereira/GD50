...
function love.update(dt)
    ...
    --IA for the right paddle
    if gameState == 'play' then
        if ball.dx > 0 and ball.x > VIRTUAL_WIDTH/3  then
            if math.abs((player2.y + player2.height/2) - (ball.y+ball.height/2)) > 15 then
            ...
            elseif math.abs((player2.y + player2.height/2) - (ball.y-ball.height/2)) < 1 then
                player2.dy = 0
            end
        else
            player2.dy = 0
